...
const Snavbar = () => {
  ...
  return (
    <Navbar bg="" variant="dark" expand="lg" style={{backgroundColor:"green"}}>
      <Container>
        <Navbar.Brand ><Link to='/shome' style={{color:"white",textDecoration:"none",fontFamily: "monospace", fontSize: "30px", fontWeight: "bold"}}>BookStore(Seller)</Link></Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto" >
            ...
            <button style={{color:"black",paddingTop:"0px",position:"relative", left:"40px",fontFamily: "monospace", fontSize: "30px", fontWeight: "bold", backgroundColor:"whitesmoke", borderRadius:"10px", padding:"5px 5px"}}>{JSON.parse(get).name} </button>
