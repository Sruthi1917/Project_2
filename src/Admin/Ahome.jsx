...
function Ahome() {
  ...
  const colors = ['#b489ecff', '#c6626eff', '#f39f5aff','orange'];
  ...
  const data = [
    { name: 'Users', value: totalUsers, fill: '#252327ff' }, 
    { name: 'vendors', value: totalvendors, fill: 'gray' },
    { name: 'Items', value: totalItems, fill: 'brown' }, 
